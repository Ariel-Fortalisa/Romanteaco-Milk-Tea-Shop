          ...
          <div class="box">
            <div class="inner-box">
              <div class="forms-wrap">
                <form class="user-form" action="login.php" method="POST" autocomplete="">
                  <div class="logo" >
              ...
              <div class="actual-form">
                ...
                <div class="login-admin" onclick="location.href='login-user.php';" style="cursor: pointer;float:right">
                    <img src="images/customer.png" alt="" style="height: 50px; width: 62px; object-fit: contain;">
              </div>
              </div>
            </form>
