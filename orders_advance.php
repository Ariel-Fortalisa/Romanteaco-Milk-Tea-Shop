...
<div class="col-12">
  ...
  <li class="nav-item" role="presentation">
  <button class="nav-link active" id="home-tab" data-toggle="tab" data-target="#home" type="button" role="tab" aria-controls="home" aria-selected="true">Advance Order</button>
  </li>
  <li class="nav-item" role="presentation">
...
<div class="tab-content" id="myTabContent">
  ...
  <?php
            ...
            if (isset($_POST['accept_order']) && isset($_POST['order_id'])) {
              ...
              $query = "UPDATE order_list SET status = 2, date = '".date("Y-m-d")."', time = '".date("H:i:s")."' WHERE order_id = $order_id";
...
// Your SQL query to fetch orders with status = 10
$query = "SELECT * FROM order_list WHERE status = 10 ORDER BY date ASC, time ASC";
$result = mysqli_query($db, $query);
...
?>
    ...
    <tr style="<?=empty($product['estimated_arrival']) ? "" : "background-color: #e0f2ff"?>">
        ...
        <td style="text-transform: capitalize"><?php echo $product['dining_option']; ?></td>
            ...
            <div class="dropdown show d-inline-block widget-dropdown" style="margin-top: -20px; margin-left: 10px">
                ...
                <ul class="dropdown-menu dropdown-menu-right" aria-labelledby="dropdown-recent-order1">
                    ...
                    <li class="dropdown-item">
                        <a href="#" onclick="acceptOrder(<?php echo $product['order_id']; ?>)"><i class="fas fa-check fa-sm" aria-hidden="true" name="clear"></i>&emsp;Prepare Now</a>
                    </li>
...
function acceptOrder(orderId) {
    ...
    $.ajax({
        type: 'POST',
        url: 'orders_advance.php', // Replace with the name of this PHP file
        data: {
            accept_order: true,
            order_id: orderId
        },
