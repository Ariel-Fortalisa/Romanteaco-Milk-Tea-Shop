...
<div class="col-12">
    <div class="card card-default">
        <div class="card-header card-header-border-bottom d-flex justify-content-between">
            ...
            <a href="orders_completed_print.php"><button class="btn" style="background-color: #76a004; color: #fff;"><i class="mdi mdi-printer"></i> Print</button></a>
       ...
       searchInput.addEventListener("input", function() {
          ...
          <style>
                   ...
                   <tbody>
                        ...
                        ?>
                           ...
                           <tr style="vertical-align: baseline;">
                               <td style="vertical-align: baseline;"><?php echo $rowCount; ?></td>
            ...
            <?php endif; ?>
                               ...
                               <td style="vertical-align: baseline;">
                                   <button style="margin-top: -5px; margin-bottom: -3px;" class="btn btn-primary view-btn" data-toggle="modal" data-target="#orderModal_<?php echo $product['order_id']; ?>">View</button>
        ...
        <div class="modal-dialog modal-sm modal-dialog-centered" role="document">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    ?>
                    <button type="button" class="btn btn-primary" id="printButton_<?php echo $product['order_id']; ?>">Print</button>
        ...
        <div class="modal-dialog modal-sm modal-dialog-centered" role="document">
            <div class="modal-content" style="background: transparent; border: none;">
                ...
                <div class="modal-body">
                    ...
                    <img src="<?php echo $product['screenshot']; ?>" alt="Product Image" style="height: 600px; width: 100%; object-fit: cover;">
                </div>
            </div>
        </div>
    </div>
...
document.getElementById('printButton_<?php echo $product['order_id']; ?>').addEventListener('click', function () {
   ...
   // Add this line to refresh the page when the user cancels the print.
