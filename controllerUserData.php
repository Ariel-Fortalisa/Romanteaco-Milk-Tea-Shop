...
if(isset($_POST['signup'])){
    ...
    $email_check = "SELECT * FROM user_account WHERE email = '$email'";
    ...
    if(count($errors) === 0){
        ...
        $insert_data = "INSERT INTO user_account (fname, lname, age, address, name, email, password, code, status, avatar)
                        values('$fname', '$lname', '$age','$address','$name', '$email', '$encpass', '$code', '$status', '$profile')";
        $data_check = mysqli_query($conn, $insert_data);
        if($data_check){
            $subject = "Email Verification Code";
            $message = "Your verification code is $code";
            $sender = "From: camarhussnie@gmail.com";
    ...
    if(isset($_POST['check'])){
        ...
        if(mysqli_num_rows($code_res) > 0){
            ...
            $code = 0;
            $status = 'verified';
            $update_otp = "UPDATE user_account SET code = $code, status = '$status' WHERE code = $fetch_code";
            $update_res = mysqli_query($conn, $update_otp);
            if($update_res){
                $_SESSION['name'] = $name;
                $_SESSION['email'] = $email;
                header('location: account-registered.php');
                exit();
            }else{
