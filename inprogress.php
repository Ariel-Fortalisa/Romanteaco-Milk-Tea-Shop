...
<div class="tab-content" id="myTabContent">
 ...
 <?php
           if (isset($_POST['done_order']) && isset($_POST['order_id'])) {
             ...
             $query = "UPDATE order_list SET status = 3 WHERE order_id = $order_id";
...
$query = "SELECT * FROM order_list WHERE status = 2";
$result = mysqli_query($db, $query);
   ...
   document.addEventListener("DOMContentLoaded", function() {
       ...
       searchInput.addEventListener("input", function() {
           ...
           <div class="input-group" id="searchmoto">
                   <input type="text" id="searchInputa" class="form-control" placeholder="Search">
               ...
               <button type="submit" name="done_order" class="btn btn-success">Done</button>
           </form>
                               </td>
                           </tr>
                       <?php endforeach; ?>
