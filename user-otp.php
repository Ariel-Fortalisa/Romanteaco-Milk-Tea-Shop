          ...
          <div class="box">
            <div class="inner-box">
              <div class="forms-wrap">
                <form class="verification-form" action="user-otp.php" method="POST" autocomplete="off">
                  <div class="logo" >
              ...
              <div class="heading">
                <h4 style="text-align: center">Code Verification</h4>
                  ...
                  <?php
                    ...
                    if (count($errors) > 0) {
                        ?>
                      <div class="alert alert-danger text-center" id="alert2" style="position: absolute; width: 80%; top: 40px; left: 0; right: 0; margin: auto">
                        <?php
            ...
            <br>
              <div class="actual-form" style="padding-bottom: 2.5rem">
                ...
                <input type="submit" name="check" value="Submit" class="sign-btn" style="font-weight: 600;"/>
              </div>
            </form>
...
<script>
    ...
    $("#alert2").delay(3000).slideUp(200, function() {
        $(this).alert('close');
    }); 
</script>
  </body>
